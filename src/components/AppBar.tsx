  ...
  return (
    <div className={styles['app-bar']}>
      <div className={styles['centered-container']}>
        ...
        <Link className={styles['github-anchor']} to="https://github.com/PauFB/ffviiec" target="_blank" rel="noreferrer">
